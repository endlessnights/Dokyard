# 🚀 Dokyard (self-hosted PaaS for Docker containers)
...
- ☁️ Supports `strict` and `relaxed` modes when deploying stacks (fail-all or partial deployment in case of errors)
